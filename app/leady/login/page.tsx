import { configuredUsers, setupStatus } from "@/lead-engine/lib/auth";
      ...
      <div className="w-full max-w-[380px]">
        ...
        {!setup.ready ? (
          <div className="rounded-3xl bg-white/[0.03] p-6 text-[14px] leading-relaxed text-white/70 ring-1 ring-line">
            ...
            <p className="mt-2">
              Lead Engine potrebuje trvalé úložisko dát. Vo Verceli otvor projekt{" "}
              <b className="text-white">portfolio-2026</b> → <b className="text-white">Storage</b> →{" "}
