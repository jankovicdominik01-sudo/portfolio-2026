...
import { fmtDateTime } from "@/lead-engine/lib/format";
import { Card, EmptyState, cn } from "@/lead-engine/components/ui";
import { FadeIn, Stagger, StaggerItem } from "@/lead-engine/components/motion";
import { MarkAllRead } from "@/lead-engine/components/mark-read";
            ...
            <Stagger>
              {items.map((n) => (
                <StaggerItem key={n.id}>
                  <Link
                    href={n.lead_id ? `/leady/leads/${n.lead_id}` : "/leady"}
